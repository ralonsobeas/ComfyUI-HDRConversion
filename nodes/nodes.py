...
class HDRConversion:     
    ...
    def to_hdr(self, image,output_path,image_name):
        ...
        dequantize_and_linearize_run(os.path.normpath(os.path.join("custom_nodes", "ComfyUI-HDRConversion", "IntrinsicHDR", "tmp")), root)
        ...
        inference(os.path.normpath(os.path.join("custom_nodes", "ComfyUI-HDRConversion", "IntrinsicHDR", "tmp")), output_path, image_name)
